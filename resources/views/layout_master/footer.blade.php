...
<section class="footer-area bg_cover" style="background-image: url(https://template.hasthemes.com/edumate-v1/edumate/assets/images/counter-bg.webp);">
    ...
    <div class="footer-copyright">
        <div class="container">
            <div class="copyright text-center">
                <p>&copy; 2023 <span> RPITSSR </span> Made with <i class="fa fa-heart"></i> by <a href="#">ICT's Department</a></p>
            </div>
        </div>
    </div>
</section>
