            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="header-logo">
                        <a href="/"><img src="{{asset('rpitssr')}}/assets/images/RPITSSR.png" width="135" height="88" alt="Logo"></a>
                    </div>
                </div>
                <div class="col-lg-7 position-static">
                    ...
                    <nav class="nav-menus-wrapper">
                        <ul class="nav-menu">
                            ...
                            <li>
                                <a class="{{ (request()->is('page/about','page/teacher','page/gallery')) ? 'active' : '' }}" href="#">Pages</a>
                                <ul class="nav-dropdown nav-submenu">
                                    <li class="{{ (request()->is('page/about')) ? 'active' : '' }}"><a href="/page/about">About</a></li>
                                    <li class="{{ (request()->is('page/teacher')) ? 'active' : '' }}"><a href="/page/teacher">Teachers</a></li>
                                    <li class="{{ (request()->is('page/gallery')) ? 'active' : '' }}"><a href="/page/gallery">Gallery</a></li>
                                </ul>
                            </li>
                            <li >
