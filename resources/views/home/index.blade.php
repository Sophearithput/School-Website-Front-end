        ...
        <div class="row no-gutters wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.2s">
            <div class="col-sm-4">
                <div class="single-specialty mt-30">
                    <div class="specialty-box">
                        <div class="box-icon">
                            <img src="{{asset('rpitssr')}}/assets/images/icon/icon-1.webp" width="70" height="70" alt="icon">
                        </div>
            ...
            <div class="col-sm-4">
                <div class="single-specialty active mt-30">
                    <div class="specialty-box">
                        <div class="box-icon">
                            <img src="{{asset('rpitssr')}}/assets/images/icon/icon-2.webp" width="70" height="70" alt="icon">
                        </div>
                        <div class="box-content">
            ...
            <div class="col-sm-4">
                <div class="single-specialty mt-30">
                    <div class="specialty-box">
                        <div class="box-icon">
                            <img src="{{asset('rpitssr')}}/assets/images/icon/icon-3.webp" width="70" height="70" alt="icon">
                        </div>
                        <div class="box-content">
            ...
            <div class="campus-image-col">
                <div class="campus-image">
                    <div class=" single-campus">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/campus-2.webp" width="521" height="392" alt="Campus">
                    </div>
                    <div class="single-campus">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/campus-1.webp" width="521" height="392" alt="Campus">
                    </div>
                </div>
            </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-6 col-md-5">
                            <div class="testimonials-image">
                                ...
                                <div class="single-testimonial-image">
                                    <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/testimonials-3.webp" width="313" height="579" alt="testimonials">
                                </div>
                            </div>
                        </div>
...
<div class="counter-area">
    <div class="container">
        <div class="counter-wrapper bg_cover" style="background-image: url({{asset('rpitssr')}}/assets/images/counter-bg.webp);">
            <div class="row">
            ...
            <div class="row-wrapper blog-active">
                    ...
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <a href="blog-details.html">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/blog-1.webp" width="370" height="250" alt="blog">
                            </a>
                        </div>
                ...
                <div class="custom-col">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <a href="blog-details.html">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/blog-2.webp" width="370" height="250" alt="blog">
                            </a>
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
                ...
                <div class="custom-col">
                    <div class="single-blog mt-30">
                        <div class="blog-image">
                            <a href="blog-details.html">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/blog-3.webp" width="370" height="250" alt="blog">
                            </a>
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
...
<section class="newsletter-area">
    <div class="container">
        <div class="newsletter-wrapper bg_cover wow zoomIn" data-wow-duration="1s" data-wow-delay="0.2s" style="background-image: url({{asset('rpitssr')}}/assets/images/newsletter-bg-1.webp);">
            <div class="row align-items-center">
                <div class="col-lg-5">
