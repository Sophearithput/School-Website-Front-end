            ...
            <div class="col-lg-7">
                <div class="about-image mt-50">
                    <div class="single-image image-1">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/about-1.webp" width="290" height="290" alt="about">
                    </div>
                    <div class="single-image image-2">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/about-2.webp" width="225" height="225" alt="about">
                    </div>
                    <div class="single-image image-3">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/about-3.webp" width="190" height="190" alt="about">
                    </div>
                    <div class="single-image image-4">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/about-4.webp" width="140" height="140" alt="about">
                    </div>

                    <div class="about-icon icon-1">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/icon/icon-1.webp" width="46" height="46" alt="icon">
                    </div>
                    <div class="about-icon icon-2">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/icon/icon-2.webp" width="46" height="46" alt="icon">
                    </div>
                    <div class="about-icon icon-3">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/icon/icon-3.webp" width="46" height="46" alt="icon">
                    </div>
                    <div class="about-icon icon-4">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/about/icon/icon-4.webp" width="46" height="46" alt="icon">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-4">
                <div class="features-image-2">
                    <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/features-2.webp" width="342" height="524" alt="Features">
                </div>
            </div>
            <div class="col-lg-8">
                <div class="features-items">
                    <div class="features-items-wrapper">
                        <div class="single-features-item d-flex align-items-center wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.2s">
                            <div class="item-icon">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/icon/icon-2-1.webp" width="70" height="70" alt="Icon">
                            </div>
                        ...
                        <div class="single-features-item d-flex align-items-center wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                            <div class="item-icon">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/icon/icon-2-2.webp" width="70" height="70" alt="Icon">
                            </div>
                            <div class="item-content media-body">
                        ...
                        <div class="single-features-item d-flex align-items-center wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.6s">
                            <div class="item-icon">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/icon/icon-2-3.webp" width="70" height="70" alt="Icon">
                            </div>
                            <div class="item-content media-body">
                    ...
                    <div class="features-items-wrapper">
                        <div class="single-features-item d-flex align-items-center wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.2s">
                            <div class="item-icon">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/icon/icon-2-4.webp" width="70" height="70" alt="Icon">
                            </div>
                            <div class="item-content media-body">
                        ...
                        <div class="single-features-item d-flex align-items-center wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                            <div class="item-icon">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/icon/icon-2-5.webp" width="70" height="70" alt="Icon">
                            </div>
                            <div class="item-content media-body">
                        ...
                        <div class="single-features-item d-flex align-items-center wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.6s">
                            <div class="item-icon">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/icon/icon-2-6.webp" width="70" height="70" alt="Icon">
                            </div>
                            <div class="item-content media-body">
            ...
            <div class="campus-image-col">
                <div class="campus-image">
                    <div class=" single-campus">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/campus-1.webp" width="585" height="392" alt="Campus">
                    </div>
                    <div class="single-campus">
                        <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/campus-2.webp" width="585" height="392" alt="Campus">
                    </div>
                </div>
            </div>
        </div>
...
<div class="counter-area-2">
    <div class="container">
        <div class="counter-wrapper-2 bg_cover" style="background-image: url(https://template.hasthemes.com/edumate-v1/edumate/assets/images/counter-bg-2.webp);">
            <div class="row">
            ...
            <div class="row teachers-row">
                    ...
                    <div class="single-teacher mt-30 text-center">
                        ...
                        <div class="teacher-image">
                            <a href="teacher-details.html">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/teachers/teacher-1.webp" width="266" height="359" alt="teacher">
                            </a>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 teachers-col">
                    <div class="single-teacher mt-30 text-center">
                        ...
                        <div class="teacher-image">
                            <a href="teacher-details.html">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/teachers/teacher-2.webp" width="266" height="359" alt="teacher">
                            </a>
                        </div>
                        <div class="teacher-content">
                            <h4 class="name"><a href="teacher-details.html">Roberto Carlos</a></h4>
                ...
                <div class="col-md-4 col-sm-6 teachers-col">
                    <div class="single-teacher mt-30 text-center">
                        ...
                        <div class="teacher-image">
                            <a href="teacher-details.html">
                                <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/teachers/teacher-3.webp" width="266" height="359" alt="teacher">
                            </a>
                        </div>
                        <div class="teacher-content">
                            <h4 class="name"><a href="teacher-details.html">Roberto Carlos</a></h4>
                        ...
                        <div class="col-lg-6 col-md-5">
                            <div class="testimonials-image">
                                <div class="single-testimonial-image">
                                    <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/testimonials-1.webp" width="313" height="579" alt="testimonials">
                                </div>
                                <div class="single-testimonial-image">
                                    <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/testimonials-2.webp" width="313" height="579" alt="testimonials">
                                </div>
                                <div class="single-testimonial-image">
                                    <img src="https://template.hasthemes.com/edumate-v1/edumate/assets/images/testimonials-1.webp" width="313" height="579" alt="testimonials">
                                </div>
